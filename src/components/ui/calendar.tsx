...
function Calendar({
  ...
  const _navClassName = cn("flex items-start gap-1", props.navClassName);
  ...
  const _selectedClassName = cn(
    "[&>button]:!bg-ctm-primary-500 [&>button]:text-ctm-background [&>button]:hover:bg-ctm-primary-500 [&>button]:hover:text-ctm-background",
    props.selectedClassName
  );
  const _todayClassName = cn(
    "[&>button]:bg-ctm-secondary-100 [&>button]:text-accent-foreground",
    props.todayClassName
  );
  const _outsideClassName = cn(
    "day-outside text-muted-foreground opacity-50 aria-selected:bg-ctm-primary-400 aria-selected:text-muted-foreground aria-selected:opacity-30",
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        MonthCaption(prop) {
          return (
            <div className="flex flex-col gap-1 mb-0 pb-0">
              <Slot {...prop} />
              {props.header}
            </div>
          );
