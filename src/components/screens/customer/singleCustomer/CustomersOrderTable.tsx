...
import { OrderRow, useGetCustomersOrdersQuery } from "@/api/customers";
import RadioItems from "@/components/ui/custom/radio/RadioItems";
import { useGetSingleOrderQuery } from "@/api/order";
...
const CustomersTable = () => {
  ...
  const { data: singleOrder, isLoading: isSingleOrderLoading } = useGetSingleOrderQuery(
    selectedErrandId ?? ""
  );
